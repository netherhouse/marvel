...
const useMarvelService = () => {
  ...
  const getComics = async (id: number | string) => {
  ...
  const _transformCharacter = (char: any) => {
    return {
      ...
      description: char.description
        ...
        : (char.description = "No description for this character yet"),
  ...
  const _transformComics = (comics: any) => {
    return {
      ...
      title: comics.title,
      description:
        comics.description || "There is no description for this comic yet",
